...
let raqam1 = 5
let raqam2 = 2
let misol = raqam1 % raqam2
let qoldiq = alert(misol)
...
let son = 12.51
let javob2 = Math.floor(son)
let chiqish = alert(javob2)
...
alert('MARS IT SCHOOL'.replaceAll(' ', '').length)
